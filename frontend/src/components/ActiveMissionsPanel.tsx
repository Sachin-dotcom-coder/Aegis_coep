                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                     {drone.status === 'on_site' ? (
                       ...
                       <span className="flex items-center gap-1.5 px-2 py-0.5 bg-green-600/20 text-green-500 rounded-md text-[9px] font-black uppercase tracking-widest">
                ...
                <div className="h-1.5 bg-white/5 rounded-full overflow-hidden">
                  <div 
                    className={`h-full transition-all duration-1000 ${
                      drone.status === 'on_site' ? 'w-full bg-red-600 shadow-[0_0_8px_rgba(239,68,68,0.5)]' : 
